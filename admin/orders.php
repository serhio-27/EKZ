    ...
    $.ajax({
        ...
        success: function(response) {
            if(response.success) {
                ...
                response.data.forEach(function(order) {
                    html += `
                        <tr>
                            ...
                            <td>${order.items_count} позиций</td>
                ...
                $('#orders_list').html(html || '<tr><td colspan="8" class="text-center">Нет заказов</td></tr>');
            } else {
                $('#orders_list').html('<tr><td colspan="8" class="text-center">Ошибка при загрузке заказов</td></tr>');
            }
        },
        error: function() {
            $('#orders_list').html('<tr><td colspan="8" class="text-center">Ошибка при загрузке заказов</td></tr>');
                ...
                html += `
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>${response.data.total_amount} ₽</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
